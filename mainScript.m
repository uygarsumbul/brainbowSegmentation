...
mergeOpts.mergeWRTnAo.maxColorDist                                       = 8; % 6; % * sqrt(size(svMeans, 2)/4);
mergeOpts.mergeCloseNeighborhoods.maxDistNormLUV                         = 8; % 6; % * sqrt(size(svMeans, 2)/4);
mergeOpts.kmeansMerging.clusterCount                                     = 40;
mergeOpts.kmeansMerging.overClusteringFactor                             = 5;
mergeOpts.kmeansMerging.maxColorDistance                                 = 8; % 6; % * sqrt(size(svMeans, 2)/4);
