...
while true
  ...
  [square_sAff, svMeans, svCells, voxelCounts, ~]                 = newMergeWRTneighborsAndOrientations(square_sAff, svMeans, svCells, voxelCounts, 1, false, stackSize, opts.mergeWRTnAo);
