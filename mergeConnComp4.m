function [square_sAff, svMeans, svCells, voxelCounts, tmpC] = mergeConnComp4(index, square_sAff, svMeans, svCells, voxelCounts, opts, connTh, careful)
...
%      mat1                              = (squareform(pdist(svMeansLUV(thisConnComp,:))) < opts.maxColorDistSizeProduct ./ tmp);
      mat2                              = (squareform(pdist(svMeansNormLUV(thisConnComp,:))) < opts.maxColorDistSizeProduct ./ tmp);

%      [Stmp, Ctmp]                      = graphconncomp(mat1 & mat2 & binsaff(thisConnComp, thisConnComp));
      [Stmp, Ctmp]                      = graphconncomp(mat2 & binsaff(thisConnComp, thisConnComp));
